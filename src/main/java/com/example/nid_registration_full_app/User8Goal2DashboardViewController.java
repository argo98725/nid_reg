...
public class User8Goal2DashboardViewController
{
    @javafx.fxml.FXML
    ...
    @javafx.fxml.FXML
    public void checkstatusOA(ActionEvent actionEvent) {
    }

    @javafx.fxml.FXML
    public void logout12(ActionEvent actionEvent) throws IOException {
    ...
    @javafx.fxml.FXML
    public void u8g2backbuttonOA(ActionEvent actionEvent) throws IOException {
